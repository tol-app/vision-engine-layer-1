...
def findNearestWebColorName(rgb_tuple):
    return findNearestColorName(rgb_tuple, WebColorMap)

def findNearestImageMagickColorName(rgb_tuple):
    return findNearestColorName(rgb_tuple, ImageMagickColorMap)
...
if __name__ == "__main__":
    color = (0, 150, 0)
    print(findNearestWebColorName(color))
    print(findNearestImageMagickColorName(color))
